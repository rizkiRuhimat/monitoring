...
<div class="row mt-3">
    <div class="col">
        ...
        <div class="container">
            <div class="row mt-3">
                <div class="col">
                    <a class="btn btn-primary" href="<?= BASEURL; ?>/vendor/add/">Tambah</a>
                </div>
            </div>
            <div class="row mt-4">
                <div class="col">
                        ...
                        <tbody>
                            ...
                            foreach ($data['vendor'] as $d) : ?>
                                <tr>
                                    ...
                                    <td><?= $d['status']; ?></td>
                                    <td>
                                        <a href="<?= BASEURL; ?>vendor/detail/<?= $d['id']; ?>" class="btn btn-primary ml-1"><span class="fas fa-eye"> View </span>
                                            <a href="<?= BASEURL; ?>vendor/edit/<?= $d['id']; ?>" class="btn btn-warning ml-1"><span class="fas fa-pen"> Edit </span>
                                                <a href="<?= BASEURL; ?>vendor/hapus/<?= $d['id']; ?>" class="btn btn-danger ml-1" onclick="return confirm('Apakah anda yakin ?');"><span class="fas fa-trash"> Delete </span>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
